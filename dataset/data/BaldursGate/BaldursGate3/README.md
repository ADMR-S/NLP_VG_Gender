There are .lsj files in the main content folders which are just json files that contain "lineIDs" and "tagText" that correspond to the contentuids in the localisation file. 
